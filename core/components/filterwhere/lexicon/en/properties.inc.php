...
$_lang['filterwhere.filtergetresourceswhere.options'] = 'JSON-encoded array of filter operator options.';
...
$_lang['filterwhere.filtergetresourceswhere.type'] = 'Type of the xPDO clause to filter the resources. Can be set to ‘where’ or ‘having’. Defaults to ‘where’.';
